import { Box, Grid as Grid, Card, CardContent, Typography, Button, alpha, Stack } from "@mui/material";
  ...
  return (
    ...
    >
      ...
      <Box sx={{
        ...
        bgcolor: alpha('#3b82f6', 0.15), filter: 'blur(100px)', borderRadius: '50%'
      }} />
      <Box sx={{
        position: 'absolute', bottom: '10%', right: '15%', width: 300, height: 300,
        bgcolor: alpha('#6366f1', 0.15), filter: 'blur(100px)', borderRadius: '50%'
      }} />
 
      <Box sx={{ position: "relative", zIndex: 2, textAlign: "center", px: 3, maxWidth: 1200 }}>
        <Stack spacing={1} sx={{ mb: 8 }}>
          <Typography
            variant="overline"
            sx={{ color: "#3b82f6", fontWeight: 800, letterSpacing: 3, fontSize: '0.9rem' }}
          >
          ...
          >
            Doctor Shift <Box component="span" sx={{ color: "#3b82f6" }}>Roster</Box>
          </Typography>
        </Stack>
            ...
            <Grid size={{ xs: 12, sm: 6, md: 4 }} key={card.title}>
              ...
              >
                <CardContent sx={{ p: 5 }}>
                  ...
                  <Typography variant="body2" sx={{ color: alpha("#fff", 0.6), mb: 4, fontWeight: 500 }}>
                    {card.subtitle}
                  </Typography>
                  ...
                  <Button
                    ...
                    sx={{
                      ...
                      textTransform: "none",
                      bgcolor: card.color,
                      "&:hover": { bgcolor: card.color, filter: 'brightness(1.1)' },
                    }}
                  >
                    Open Module
                  </Button>
